/*Given a singly linked list of size N containing only English Alphabets, arrange the consonants and vowel nodes of the list it in such a way that all the vowels nodes come before the consonants while maintaining the order of their arrival.
1.     Input: a e g h i m;          Output: a e i g h m
2.     Input: q r t;             Output: q r t
*/
#include<iostream.h>
#include<conio.h>
struct Node
...
void main()
{
    ...
    cout<<"ARRANGE VOWELS & CONSONANTS IN A SINGLY LINKED LIST"<<endl;
    cout<<"\nLinked list before :";
    printlist(head);
